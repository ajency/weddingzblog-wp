...
<script src="<?php echo get_template_directory_uri(); ?>/js/view-cart.js?_2" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/add-to-cart.js?_2" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/gps-modal-prompt.js?_2" type="text/javascript"></script>
    <?php wp_footer(); ?>
