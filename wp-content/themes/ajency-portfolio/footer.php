...
<script src="<?php echo get_template_directory_uri(); ?>/js/view-cart.js?_11" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/add-to-cart.js?_11" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/gps-modal-prompt.js?_11" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/sign-in.js?_11" type="text/javascript"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/verify-otp.js?_11" type="text/javascript"></script>
